 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://tp2/", wsdlLocation = "http://localhost:8080/WebApplication/CalculatorService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://tp2/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication/CalculatorService?WSDL");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://tp2/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp2/", "CalculatorPort"), Calculator.class, features);
    }
