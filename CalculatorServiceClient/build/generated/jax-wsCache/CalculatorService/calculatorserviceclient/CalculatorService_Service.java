 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://webservice.hubberspot.com/", wsdlLocation = "http://localhost:8080/Calculator/CalculatorService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://webservice.hubberspot.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Calculator/CalculatorService?WSDL");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://webservice.hubberspot.com/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.hubberspot.com/", "CalculatorServicePort"), CalculatorService.class, features);
    }
